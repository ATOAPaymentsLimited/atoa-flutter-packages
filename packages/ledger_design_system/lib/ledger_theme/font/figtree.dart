...
extension FigTreeTextTheme on BuildContext {
  ...
  TextStyle get caption =>
      _defaultStyle.copyWith(fontSize: 12.sp, height: 1.5, package: 'ledger_design_system');

  /// Overline is Text Style with 11px size and 160% height
  TextStyle get overline =>
      _defaultStyle.copyWith(fontSize: 11.sp, height: 1.6, package: 'ledger_design_system');
  ...
  TextStyle get labelExtraSmall => _defaultStyle.copyWith(
        fontSize: 12.sp,
        height: 1.6,
        letterSpacing: 0.1,
