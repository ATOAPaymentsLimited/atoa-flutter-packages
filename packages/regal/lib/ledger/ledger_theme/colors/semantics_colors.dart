...
import 'package:regal/ledger/ledger_theme/colors/abstract_color_system.dart';
...
class ErrorColor extends SemanticColorSystem {
  ErrorColor._(
    this._subtle,
    this._lighter,
    this._defaultColor,
...
class NoticeColor extends SemanticColorSystem {
  NoticeColor._(
    this._subtle,
    this._lighter,
    this._defaultColor,
...
class NegativeColor extends SemanticColorSystem {
  NegativeColor._(
    this._subtle,
    this._lighter,
    this._defaultColor,
...
class PositiveColor extends SemanticColorSystem {
  PositiveColor._(
    this._subtle,
    this._lighter,
    this._defaultColor,
...
/// Error colors are used across error states and in "destructive" actions. They communicate a destructive/negative action, such as removing a user from your team.
class InfoColor extends SemanticColorSystem {
  InfoColor._(
    this._subtle,
    this._lighter,
    this._defaultColor,
