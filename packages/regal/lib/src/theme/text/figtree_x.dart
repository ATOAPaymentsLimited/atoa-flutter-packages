...
@immutable
class FigTreeX extends ThemeExtension<FigTreeX> {
  const FigTreeX({
  ...
  @override
  ThemeExtension<FigTreeX> copyWith({
  ...
  @override
  ThemeExtension<FigTreeX> lerp(
    covariant ThemeExtension<FigTreeX>? other,
    double t,
  ) {
    if (other is! FigTreeX) {
      return this;
    }
